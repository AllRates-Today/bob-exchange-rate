'use strict';
// Bank of Botswana exchange rates via the AllRatesToday API.
const BASE = 'https://allratestoday.com/api/v1/central-bank/bob';
...
/** Latest rate for one pair, e.g. getRate('USD', 'BWP', { apiKey }). */
